...
return (
  <div className="min-h-screen bg-[#f8fafc] p-3 sm:p-4 md:p-6 lg:p-8 text-slate-900">
    <div className="mx-auto max-w-6xl">
      ...
      {/* Resume */}
      <div className="mt-4 md:mt-6 rounded-[28px] border border-slate-200 bg-white p-4 sm:p-5 md:p-6 shadow-[0_16px_45px_rgba(15,23,42,.07)]">
        <ResumeStatus resume={resume} />
      </div>

      {/* Company Search */}
      <div className="mt-4 md:mt-6 rounded-[28px] border border-slate-200 bg-white p-4 sm:p-5 md:p-6 shadow-[0_16px_45px_rgba(15,23,42,.07)] transition-all duration-300 hover:border-sky-200 hover:shadow-[0_20px_55px_rgba(15,23,42,.1)]">
        <h2 className="mb-5 md:mb-6 text-xl sm:text-2xl font-bold text-slate-900">
          Analyze Company
        </h2>
          ...
          <div className="mt-6 md:mt-8 flex justify-center">
            <button
              ...
              className="
                ...
                text-sm md:text-base
                font-semibold text-white
                shadow-[0_10px_25px_rgba(15,23,42,.25)]
                transition-all duration-300
                hover:bg-slate-800
                hover:scale-[1.01]
                hover:shadow-[0_14px_30px_rgba(15,23,42,.35)]
              "
            >
              🚀 Start AI Interview
            </button>
    ...
    {loading && (
      <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm p-4">
        <div className="w-full max-w-sm rounded-2xl border border-slate-200 bg-white p-5 sm:p-6 text-center shadow-[0_20px_60px_rgba(15,23,42,.2)]">
          <div className="mx-auto flex h-14 w-14 sm:h-16 sm:w-16 items-center justify-center rounded-full bg-sky-50">
            <div className="h-8 w-8 sm:h-10 sm:w-10 animate-spin rounded-full border-4 border-sky-500 border-t-transparent"></div>
          </div>

          <h2 className="mt-5 text-lg sm:text-xl font-bold text-slate-900">
            AI is analyzing...
          </h2>
