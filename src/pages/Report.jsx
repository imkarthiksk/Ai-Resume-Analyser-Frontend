    ...
    <div className="max-w-6xl mx-auto bg-white rounded-2xl shadow-xl p-4 sm:p-6 md:p-10">
      ...
      <div className="flex flex-col gap-4 sm:flex-row sm:justify-between sm:items-center">
        ...
        <button
          ...
          className="w-full sm:w-auto bg-blue-700 hover:bg-blue-800 text-white px-6 py-3 rounded-xl"
        >
          ← Back
        </button>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6 mt-8 md:mt-10">
        ...
        <div className="bg-gray-100 p-5 md:p-6 rounded-xl">
        ...
        <div className="bg-blue-100 p-5 md:p-6 rounded-xl">
      ...
      <div className="mt-8 md:mt-10">
        ...
        {Object.entries(data.report.rounds || {}).map(
          ([roundName, questions], index) => (
            ...
            <div
              key={index}
              className="bg-gray-100 rounded-2xl p-4 md:p-8 mb-8 md:mb-10"
            >
      ...
      <div className="flex flex-col sm:flex-row justify-center gap-4 mt-8 md:mt-10">
        ...
        <button
          ...
          className="w-full sm:w-auto bg-blue-700 hover:bg-blue-800 text-white px-8 py-3 rounded-xl"
        >
          Back to Dashboard
        </button>
